...
public class JedisUtil {
  ...
  static {
    ...
    int JEDIS_TIMEOUT = Integer.parseInt(PropertiesUtil.getValueByKey("jedis.timeout", "60000"));
    ...
    if (JEDIS_PASSWORD.isEmpty())
      ...
      jedisPool = new JedisPool(config, JEDIS_IP, JEDIS_PORT, JEDIS_TIMEOUT, JEDIS_PASSWORD);
  }
